...
function kadence_build_child_register_options() {
	...
	$cmb_options_cloud = new_cmb2_box( array(
		...
		'title'        => esc_html__( 'Pattern Hub Config', 'kadence-child-theme-builder' ),
		'object_types' => array( 'options-page' ),
		'option_key'   => 'kadence_build_child_cloud_config',
		'parent_slug'  => 'kadence_build_child_theme_config',
		'tab_group'    => 'kadence_build_child_main_options',
		'tab_title'    => 'Pattern Hub Config',
		'display_cb'   => 'kadence_build_child_page_output', // Override the options-page form output (CMB2_Hookup::options_page_output()).
	) );
	...
	$cmb_options_cloud->add_field( array(
		'name'       => esc_html__( 'Pattern Hub Name', 'kadence-child-theme-builder' ),
		'id'         => 'kct_cloud_name',
		'type'       => 'text',
	) );
	$cmb_options_cloud->add_field( array(
		'name'       => esc_html__( 'Pattern Hub Access URL', 'kadence-child-theme-builder' ),
		'id'         => 'kct_cloud_url',
		'type'       => 'text_url',
	) );
	$cmb_options_cloud->add_field( array(
		'name'       => esc_html__( 'Pattern Hub Access Key', 'kadence-child-theme-builder' ),
		'id'         => 'kct_cloud_key',
		'type'       => 'text',
	) );
}
